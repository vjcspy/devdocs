...
3) Services: Identify important services. For each: purpose, main functions, inputs/outputs, side effects (DB, cache, queue, HTTP calls), idempotency/retries, and error taxonomy.
...
8) Output Assembly:
   ...
   - “Key Services & Logic” (Core Services & Responsibilities)
...
Deliverable: Update docs to this file. Take a deep breath and work on this problem step-by-step.