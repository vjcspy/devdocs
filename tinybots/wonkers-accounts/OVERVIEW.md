...
- `test/controller/AccountControllerIT.ts` and other fixtures hard-code the root MySQL password (`sgTLz4rcNL1SM5lu`). This is effectively a secret in source control—move credentials to env vars or a secrets manager.
